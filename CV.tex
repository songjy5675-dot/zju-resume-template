...
\begin{tikzpicture}[remember picture, overlay] 
    \node[anchor = north east] at ($(current page.north east)+(-2cm,-0.8cm)$) {\includegraphics[height=3cm]{humanpicture.jpg}};
  \end{tikzpicture}%
...
\textbf{一种基于人工表面等离激元的通感一体化微带传输线结构设计} \hfill 2025.10 -- 至今 \titlebreak
